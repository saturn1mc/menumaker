...
public class MMRecipeElement implements Comparable<MMRecipeElement> {
	...
	public String toString() {
		return quantity + " " + ingredient.getUnit().toString() + " of "
				+ ingredient.toString();
	}

	@Override
	public int compareTo(MMRecipeElement o) {
		return ((Integer) this.getIngredient().getShopPoint().getPriority())
				.compareTo(o.getIngredient().getShopPoint().getPriority());
	}
